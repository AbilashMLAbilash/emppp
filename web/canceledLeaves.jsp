<%-- 
    Document   : canceledLeaves
    Created on : 29 Mar, 2023, 11:55:22 AM
    Author     : ELCOT
--%>
...
<!--		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>Filter<b> Canceled Leaves</b></h2>
						</div>
       ...
       Connection con=null;
    {
        try
		{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/abilashproject","root","root");
                        ...
                        PreparedStatement ps=con.prepareStatement("Select * from leave_request where leavestatus='Canceled' and startdate between (?) and (?)");
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
                        ...
                        try
                        {
                          ...
                          ResultSet rs=st.executeQuery("select * from leave_request where leavestatus='Canceled'");
                          while(rs.next())
                          {
                    %>
