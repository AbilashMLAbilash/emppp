...
<!--		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>Filter<b> Canceled Duty</b></h2>
						</div>
       ...
       Connection con=null;
    {
        try
		{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/abilashproject","root","root");
                        ...
                        PreparedStatement ps=con.prepareStatement("Select * from duty_request where status='Canceled' and date between (?) and (?)");
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
                        ...
                        try
                        {
                          ...
                          ResultSet rs=st.executeQuery("select * from duty_request where status='Canceled'");//"select * from duty_request where status='Approved'"
                          while(rs.next())
                          {
                    %>
