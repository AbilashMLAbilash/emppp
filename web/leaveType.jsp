...
//			String str="insert into manage_leave values(?,?,?,?)";
...
//    
//    
//        sick_leave=request.getParameter("tsl");
//        casual_leave=request.getParameter("tcl");
//        festival_leave=request.getParameter("tfl");
//        birthday_leave=request.getParameter("tbl");
       ...
       Connection con=null;
    {
        try
		{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/abilashproject","root","root");
                        ...
                        String str="update manage_leave set sick_leave=?,casual_leave=?,festival_leave=?,birthday_leave=?";
...
//        out.print(name);
    ...
    */
    ...
    %>
    <%
        out.print("Leave Type Updated Successfully");
    %>
            ...
            <div  class="content">
                 <div class="input-box">
                        ...
                        <input type="number" id="quantity" name="tsl" min="1" max="6" value="sick_leave">
                    </div>
                <div class="input-box">
                        <label for="name">Casual Leave</label>
                        
                        <input type="number" id="quantity" name="tcl" min="1" max="6" value="casual_leave">
                    </div>
                    <div class="input-box">
                        <label for="name">Festival Leave</label>
                        
                        
                        <input type="number" id="quantity" name="tfl" min="fl" max="6" value="Festival">
                    </div>
<!--                    <div class="input-box">
...
<!--                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="number" id="quantity" name="tbl" min="1" max="2" value="Birthday_leave">
                    </div>
