...
<!--                                                    <th>Block</th>-->
                    ...
                    <td><button style="background-color: green;border-radius:border-radius:5px  "><a href="signup_1.jsp?username=<%=rs.getString(1)%>" style="font-size:15px;background-size:27px ;background-color: green;border-radius:5px ;color: white" >Edit</button></td>
