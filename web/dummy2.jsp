		...
		<div class="table-responsive">
			<div class="table-wrapper">
				...
				<table class="table table-striped table-hover">
                    ...
                    <td><button style="background-color: green;border-radius:border-radius:5px  "><a href="editemployeeadmin.jsp?username=<%=rs.getString(1)%>" style="font-size:15px;background-size:27px ;background-color: green;border-radius:5px ;color: white" >Edit</button></td>
                    <td><button style="background-color: red;border-radius:border-radius:5px  "><a href="deleteemployee.jsp?username=<%=rs.getString(1)%>" style="font-size:15px;background-size:27px ;background-color: red;border-radius:5px ;color: white" >Delete</button></td>
                   <td><button style="background-color: blue"><a href="employeeStatusInActive.jsp?username=<%=rs.getString(1)%>" style="font-size:15px;background-size:27px ;background-color: blue;border-radius:5px ;color: white" >Block</button></td>
                </tr>
                <%
                    }}
                        catch(Exception e)
