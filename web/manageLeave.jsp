<%-- 
    ...
    Created on : 29 Mar, 2023, 9:59:00 AM
    Author     : ELCOT
///// alternate for this page manageLeave_1.jsp
--%>
...
<%
    ...
    %>
            ...
            try
            {
                ...
                ResultSet rs=st.executeQuery("select * from leave_request where leavestatus='pending'");
                while(rs.next())
                {
            %>
            <td><%=rs.getString(1)%></td>
            ...
            <td><%=rs.getString(8)%></td>
            <td><%=rs.getString(9)%></td>
            <td><button style="background-color: green;border-radius:border-radius:5px  "><a href="manageLeaveApprove.jsp?id=<%=rs.getString(1)%>" style="font-size:15px;background-size:27px ;background-color: green;border-radius:5px ;color: white" > Approve </button></td>
            <td><button style="background-color: red;border-radius:border-radius:5px  "><a href="manageLeaveCancel.jsp?id=<%=rs.getString(1)%>" style="font-size:15px;background-size:27px ;background-color: red;border-radius:5px ;color: white" > Cancel </button></td>
        </tr>
        <%
            }
            }
